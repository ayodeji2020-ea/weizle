...
if($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $results = $setupModel->confirmSub($paramReceived);
    ...
    if($results === -1){
        ...
        $newhttp->customResp(400, "05", "Subscription confirmation failed");
        
    }elseif($results === -4){
        
        $newhttp->customResp(400, "05", "Subscription not successful");
