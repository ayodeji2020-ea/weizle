...
if($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $results = $userModel->weizleNotifier($paramReceived);
    ...
    if($results === -1){
        ...
        $newhttp->customResp(400, "05", "Notification service failed");
        
    }elseif($results === -5){
        
        $newhttp->customResp(400, "06", "Emergency setup is inactive");
